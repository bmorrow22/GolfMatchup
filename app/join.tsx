...
export default function JoinScreen() {
  ...
  // 1. AUTO-LOAD PROFILE DATA ON MOUNT
  useEffect(() => {
    const getProfileData = async () => {
      try {
        ...
        if (savedName || savedEmail || savedHC) {
          setForm({
            name: savedName || '',
            email: savedEmail || '',
            hc: savedHC || ''
        ...
        console.error("Failed to load profile for auto-fill", e);
      }
    };
    getProfileData();
  }, []);
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        <View style={styles.card}>
          ...
          <View style={styles.inputGroup}>
            ...
            />
            <Text style={styles.hint}>Adjusting this only affects this round.</Text>
          </View>
